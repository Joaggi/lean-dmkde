...
algorithms = ["sos", "copod", "loda", "vae", "deepsvdd"]

for algorithm in algorithms:

    setting = {
        "z_name_of_experiment": ("pyod-"+algorithm+'-lympho'),
    ...
    if algorithm == "knn":
        prod_settings = {"z_nu": [i/100 for i in range(1,21)], "z_n_neighbors" : [10*i for i in range(1,8)]}
