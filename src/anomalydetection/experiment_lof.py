...
def experiment_lof(X_train, y_train, X_test, y_test, setting, mlflow, best=False):
    ...
    #for i, setting in enumerate(settings):
        ...
        with mlflow.start_run(run_name=setting["z_run_name"]):
            ...
            nu, neig = setting["z_nu"], setting["z_n_neighbors"]
            print(f"experiment: contamination {nu}, neighbors {neig} - metrics {metrics}")
