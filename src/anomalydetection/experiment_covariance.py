...
def experiment_covariance(X_train, y_train, X_test, y_test, settings, mlflow, best=False):
    ...
    for i, setting in enumerate(settings):
        ...
        with mlflow.start_run(run_name=setting["z_run_name"]):
            ...
            metrics = calculate_metrics(y_test, y_test_pred, y_scores)            
            ...
            print(f"experiment {i} metrics {metrics}")