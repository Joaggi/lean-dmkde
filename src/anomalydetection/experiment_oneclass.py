...
def experiment_oneclass(X_train, y_train, X_test, y_test, setting, mlflow, best=False):
    ...
    #for i, setting in enumerate(settings):
        ...
        with mlflow.start_run(run_name=setting["z_run_name"]):
            ...
            nu, gamma = setting["z_nu"], setting["z_gamma"]
            print(f"experiment: contamination {nu}, gamma {gamma} - metrics {metrics}")
