...
def experiment_leand_aenotrain(X_train, y_train, X_test, y_test, setting, mlflow, best=False):
    ...
    #for i, setting in enumerate(settings):
        ...
        with mlflow.start_run(run_name=setting["z_run_name"]):
            ...
            if setting["z_autoencoder_is_alone_optimized"] == True or setting["z_adaptive_fourier_features_enable"] == True:
